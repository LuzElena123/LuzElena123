...
- 📊 Analista de datos con enfoque en análisis exploratorio de datos, métricas de negocio, **KPIs** y visualización  
...
- Matplotlib  
- Seaborn  
- Tableau (Básico) / Power BI (Básico)
...
Proyecto de análisis de datos enfocado en identificar patrones de videojuegos exitosos utilizando datos de ventas, reseñas, plataformas, géneros y clasificaciones ESRB.  
